...
public class AbstractPet extends TamableAnimal implements GeoEntity, RangedAttackMob {
    ...
    private static final java.util.List<net.minecraft.world.entity.ai.sensing.SensorType<? extends net.minecraft.world.entity.ai.sensing.Sensor<? super AbstractPet>>> SENSOR_TYPES = java.util.List.of(
        ...
        com.dwinovo.chiikawa.init.InitSensor.PET_ATTACKBLE_ENTITY_SENSOR.get(),
        com.dwinovo.chiikawa.init.InitSensor.PET_HARVEST_CROP_SENSOR.get(),
        com.dwinovo.chiikawa.init.InitSensor.PET_PLANT_CROP_SENSOR.get(),
        com.dwinovo.chiikawa.init.InitSensor.PET_CONTAINER_SENSOR.get(),
        com.dwinovo.chiikawa.init.InitSensor.PET_ITEM_ENTITY_SENSOR.get()
    );
