...
public final class InitItems {
    ...
    public static final DeferredItem<SpawnEggItem> USAGI_SPAWN_EGG =
            ITEMS.registerItem("usagi_spawn_egg", SpawnEggItem::new, () -> new Item.Properties().spawnEgg(InitEntity.USAGI_PET.get()));
    public static final DeferredItem<SpawnEggItem> HACHIWARE_SPAWN_EGG =
            ITEMS.registerItem("hachiware_spawn_egg", SpawnEggItem::new, () -> new Item.Properties().spawnEgg(InitEntity.HACHIWARE_PET.get()));
    public static final DeferredItem<SpawnEggItem> CHIIKAWA_SPAWN_EGG =
            ITEMS.registerItem("chiikawa_spawn_egg", SpawnEggItem::new, () -> new Item.Properties().spawnEgg(InitEntity.CHIIKAWA_PET.get()));
    public static final DeferredItem<SpawnEggItem> SHISA_SPAWN_EGG =
            ITEMS.registerItem("shisa_spawn_egg", SpawnEggItem::new, () -> new Item.Properties().spawnEgg(InitEntity.SHISA_PET.get()));
    public static final DeferredItem<SpawnEggItem> MOMONGA_SPAWN_EGG =
            ITEMS.registerItem("momonga_spawn_egg", SpawnEggItem::new, () -> new Item.Properties().spawnEgg(InitEntity.MOMONGA_PET.get()));
    public static final DeferredItem<SpawnEggItem> KURIMANJU_SPAWN_EGG =
            ITEMS.registerItem("kurimanju_spawn_egg", SpawnEggItem::new, () -> new Item.Properties().spawnEgg(InitEntity.KURIMANJU_PET.get()));
    public static final DeferredItem<SpawnEggItem> RAKKO_SPAWN_EGG =
            ITEMS.registerItem("rakko_spawn_egg", SpawnEggItem::new, () -> new Item.Properties().spawnEgg(InitEntity.RAKKO_PET.get()));
